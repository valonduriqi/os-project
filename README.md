...
See [TASKS.md](./TASKS.md) for your assignment requirements.

Feel free to add extra features beyond the assignment if you want — polish, new apps, UX improvements, etc. Not required, but encouraged if you have time.

## Features (starter)

- Authentication flow with validation.
- Main screen with app launcher.
- Applications — Camera, Browser, Documents.
- Power off button.
